...
public class ReclamationAdapter extends RecyclerView.Adapter<ReclamationAdapter.ReclamationViewHolder> {
    ...
    // Constructeur
    public ReclamationAdapter(Context context, List<Reclamation> reclamationList, ReclamationDatabase db, OnUpdateClickListener onUpdateClickListener) {
    ...
    public void onBindViewHolder(@NonNull ReclamationViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(holder.itemView.getContext(), ReclamationDetails.class);
